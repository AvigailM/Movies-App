...
<module external.linked.project.id=":react-native-fbsdk" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="Gradle: com.facebook.android:facebook-login:7.0.0@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.facebook.android:facebook-share:7.0.0@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.facebook.android:facebook-common:7.0.0@aar" level="project" />
    <orderEntry type="library" name="Gradle: androidx.appcompat:appcompat:1.1.0@aar" level="project" />
    <orderEntry type="library" name="Gradle: com.facebook.android:facebook-core:7.0.0@aar" level="project" />
